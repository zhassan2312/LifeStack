...
import { useTaskStore } from '../store/useTaskStore'; // Adjust path if needed

const CompletedTotalChart = ({ title }) => {
  const {
    past10DaysData,
    past10WeeksData,
    past10MonthsData,
          ...
          <ResponsiveContainer width="100%" height="100%">
            <LineChart data={chartData}>
              ...
              <Line
                ...
                stroke="#5A9BFF"
                strokeWidth={2}
                dot={{ stroke: '#5A9BFF', strokeWidth: 2, r: 4, fill: '#fff' }}
...
export default CompletedTotalChart;