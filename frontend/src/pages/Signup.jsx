...
const Signup = () => {
  ...
  return (
    <div className="h-screen grid lg:grid-cols-2">
          ...
          <form onSubmit={handleSubmit} className="space-y-24">
            <div className="form-control">
              <label className="flex items-center mb-8">
                <span className="text-18 font-semibold">Full Name</span>
              </label>
              <input
                type="text"
                className="p-12 gap-12 placeholder:text-(--color-black-40) border-1 border-(--color-black-10) focus:border-(--color-black-20) rounded-12 flex w-full"
            ...
            <Button
              ...
              icon={isSigningUp ? null : <MessageSquare className="w-18 h-18" />}
      ...
      <AuthImagePattern
        title={"Join LifeStack!"}
        subtitle={"Create your account to Manage your life and finances."}
      />
    </div>
  );
};
